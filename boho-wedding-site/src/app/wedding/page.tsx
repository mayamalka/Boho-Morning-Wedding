...
export default function WeddingSite() {
  ...
  return (
    <div className={`relative ${showOverlay ? 'pointer-events-none' : ''}`}>
      {showOverlay && <VideoOverlay onClose={handleOverlayClose} />}
      <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
            ...
            <div ref={playlistRef} className="pt-16 -mt-16" id="playlist">
              <Card className="p-8 text-center bg-white/85 border border-sky-100 shadow-lg h-full flex flex-col justify-between">
                ...
                {/* spotify colaborator links expire in 7 days, last changed in 19.3.26 */}
                <Button className="bg-sky-300 hover:bg-sky-400 text-white mx-auto flex items-center gap-2"
                  onClick={() => window.open("https://open.spotify.com/playlist/5QwjNLFkyrClLVctm9DTK6?si=f0aac0bb5a294961&pt=1477c7bb13a1af35c85001f50932170c", "_blank")}
                  >
                    <Image
          ...
          <div ref={photosRef} className="pt-16 -mt-16" id="photos">
            <Card className="p-8 mb-10 bg-white/85 border border-sky-100 shadow-lg">
              <div className="text-center">
                <h2 className="text-3xl font-['Cormorant_Garamond'] text-sky-400 mb-2">Share Your Photos • <span className="font-['Amatic_SC'] font-bold">שתפו את התמונות שלכם</span></h2>
                <p className="font-['Montserrat'] text-gray-600 mb-2">
                  Please help us collect memories! Upload your wedding photos to our Google Drive folder so we can add them to the website's gallery.
                </p>
                <p className="font-['Heebo'] text-sm font-light mb-4 text-gray-600">
                  עזרו לנו לאסוף זכרונות! העלו את התמונות שלכם מהחתונה לתיקיית גוגל דרייב שלנו כדי שנוכל להוסיף אותן לגלריית האתר.
                </p>
                <div className="flex flex-col items-center justify-center space-y-6">
                  ...
                  >
                    Upload Photos • <span className="font-['Heebo']">העלאת תמונות</span>
                  </Button>
                  ...
                  <div className="mt-2 text-xs text-gray-500 font-['Montserrat'] italic">
                    ...
                    <p className="font-['Heebo']">קבצים נתמכים: JPG, PNG. עד 10MB לתמונה. התמונות עשויות להופיע באלבום החתונה.</p>
                  </div>
                </div>
              </div>
            </Card>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-6">
                ...
                <div className="text-right space-y-6 rtl">
                  <p className="font-['Heebo'] text-lg font-light">
                    הכרנו במסיבת סילבסטר דרך חברים משותפים, שהמליצו לנו אחד על השנייה.
                    התחברנו על האהבה המשותפת שלנו למוזיקה, עילי כנגן סקסופון ומאיה כזמרת ופסנתרנית.
                  </p>

                  <p className="font-['Heebo'] text-lg font-light">
                    הקליק שלנו היה כל כך מיידי, שהדייט הראשון שלנו היה מיד ביום אחרי.
                    בדייט השני כבר פגשנו את המשפחה אחת של השנייה, וארבעה חודשים לתוך הקשר כבר תכננו טיסה ביחד.

                  </p>

                  <p className="font-['Heebo'] text-lg font-light">
                    בשנה הראשונה שלנו כבשנו את ספרד ביחד, השתלבנו עם המשפחות אחת של השנייה והתחברנו עוד עם האהבה שלנו לחיות, 
                    חלמנו על לגור בבית משלנו, עם כלב וחתול שאוהבים אחד את השני כמו שאנחנו אוהבים.
                    בינתיים עילי הספיק להתחיל ללמוד, מאיה הספיקה להשתחרר ולעבוד. נהנינו מכל פסגה שכבשנו ביחד.
                  </p>

                  <p className="font-['Heebo'] text-lg font-light">
                    אחרי שנה וחצי נהדרות, שעילי חפר למאיה על היסטוריה והיא בתמורה הסבירה לו שוב ושוב על מדעי המחשב, החלטנו לעבור לגור ביחד.
                    מאיה עיצבה ותכננה איך ייראה הבית, ועילי עיצב את הספרייה. 
                    משם הבאנו את החיות היקרות פרדי, ג'יני ומרגול, והיינו מוכנים לעבור לשלב הבא בסיפור שלנו.
                    כל צעד שלקחנו ביחד היה בביטחון מוחלט, כי כשיודעים, יודעים.
                  </p>
                </div>
              </div>
            </Card>
